          ...
          <div className="mt-6 mb-4 flex flex-col sm:flex-row items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Portal Pengembangan Sumber Daya Manusia Sekretariat Jenderal
                  DPD RI
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {quickLinks.map((link, i) => (
                <button
                  ...
                  className="group flex items-start gap-3 rounded-xl border border-gray-100 dark:border-gray-700 bg-slate-50 dark:bg-gray-700/50 p-4 text-left hover:bg-white dark:hover:bg-gray-700 hover:shadow-sm transition"
                >
                  <div
                  ...
                  >
                    {link.type === "book" && (
                      ...
                      >
                        <path d="M4 5a2 2 0 012-2h11a3 3 0 013 3v13a1 1 0 01-1.447.894L16 18.118l-2.553 1.776A1 1 0 0112 18.999V5H6a2 2 0 00-2 2V5z" />
                      </svg>
                    )}
                    {link.type === "help" && (
                      <svg
                        ...
                        className="h-5 w-5 text-teal-600 dark:text-teal-400"
                      >
                        <path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 15a1.25 1.25 0 110 2.5A1.25 1.25 0 0112 17zm-1-3.5a1 1 0 112 0v.25c0 .414-.336.75-.75.75h-.5A1.75 1.75 0 019 12.75V12a3 3 0 016 0 1 1 0 11-2 0 1 1 0 10-2 0v.25z" />
                      </svg>
                    )}
                    {link.type === "chat" && (
                      <svg
                    ...
                    {link.type === "external" && (
                      ...
                      >
                        ...
                        <path d="M5 5h6v2H7v10h10v-4h2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2z" />
                      </svg>
                    )}
                  </div>
                  <div>
